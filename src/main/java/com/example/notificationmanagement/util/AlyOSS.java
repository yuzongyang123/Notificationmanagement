...
public class AlyOSS {
    ...
    static final String endpoint = "https://oss-cn-guangzhou.aliyuncs.com";
    static final String keyid="your";
    static final String secret="your";
    static final String bucketName = "yangge123123";
